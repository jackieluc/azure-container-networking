...
FROM --platform=linux/${ARCH} mcr.microsoft.com/oss/go/microsoft/golang:1.26.6@sha256:03bf54070e68e188526dddb6c58edb00d0999aa5c554579410d0fc0b39349c68 AS go
ARG VERSION
ARG DEBUG
ARG OS
ARG ARCH
